...
public class SwerveSubsystem extends SubsystemBase
{
  ...
  public SwerveSubsystem(File directory)
  {
    ...
    double angleConversionFactor = SwerveMath.calculateDegreesPerSteeringRotation(12);
    // Motor conversion factor is (PI * WHEEL DIAMETER IN METERS) / (GEAR RATIO * ENCODER RESOLUTION).
    //  In this case the wheel diameter is 3 inches, which must be converted to meters to get meters/second.
